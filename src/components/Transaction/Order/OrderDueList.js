...
import { getDueList } from "../../../actions/orderAction";
...
class OrderDueList extends Component {
  state = { query: "" };
  ...
  renderOrderDueList() {
    ...
    let { orderDueList } = this.props;

    if (query) {
      orderDueList = orderDueList.filter(
        (order) =>
...
const mapStateToProps = (state) => {
  return { orderDueList: Object.values(state.order.orderDueList) };
};

export default connect(mapStateToProps, { getDueList })(OrderDueList);
